VERSION 5.00
Begin VB.Form frmGlinton 
   AutoRedraw      =   -1  'True
   Caption         =   "Glinton Usb Writer"
   ClientHeight    =   5508
   ClientLeft      =   108
   ClientTop       =   432
   ClientWidth     =   6612
   LinkTopic       =   "frmGlinton"
   ScaleHeight     =   5508
   ScaleWidth      =   6612
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ListBox lstResults 
         ...
         EndProperty
         Height          =   1080
         ItemData        =   "frmGlinton.frx":0000
         Left            =   120
         List            =   "frmGlinton.frx":0002
         TabIndex        =   9
         Top             =   1080
         Width           =   6012
      End
...
Function SelectEPC()
    ...
    vSelectEPC = READER_T_EPC + frmGlinton.txt_EPC_Data.Text + "AA"
...
Private Sub BTN_M_WriteEPC_Click()
    ...
    While ((gTAG.ACC_COUNT < 10) And (gTAG.ACC_RESULT <> "00") And (gTAG.DATAFORMAT_ERR = False))
        ...
        WriteReport (SelectEPC)
        ' 811A0006001500000200000120006000000000000000000250901599AA
        ReadUSB_Report
        DataStr = READER_W_EPC + "00000000" + Me.txt_EPC_Data_New.Text
        Debug.Print DataStr
        WriteReport (DataStr)
        ' 821A000700150002010200000000000000000000000000000250901588
        ' 821A000700150002010200000000000000000000000000000250901588
        Sleep (30)
...
ReadReport
frmGlinton.Timer1.Enabled = True
End Sub

Private Sub btn_ScanStop_Click()
WriteReport (READER_T_STOPSCAN)
ReadReport
frmGlinton.Timer1.Enabled = False
End Sub
...
''''    RxLevel = Hex$(CStr(256 + frmGlinton.HS_RxSensetivity.Value))
''''
''''    ''''frmGlinton.txt_RX_Sensetivity.Text = frmGlinton.HS_RxSensetivity.Value
...
''''    Dim bb As Byte
''''    'TxPower = CStr(0 - frmGlinton.HS_TxPower.Value)
''''    TxPower = Hex$(CStr(0 - frmGlinton.HS_TxPower.Value))
''''    ''''frmGlinton.txt_TX_Power.Text = frmGlinton.HS_TxPower.Value
    ...
    'print log to TextIR text box
        ...
        Select Case RdCmdStr
          Case "ReadTag"
                    ...
                    frmGlinton.txt_EPC_Data.Text = gTAG.EPC

          Case Else
                    'frmGlinton.TextIR.Text = 'frmGlinton.TextIR.Text + "< " + ByteValueOutput + vbCrLf
        End Select
    ...
    Next Count
        ...
        Select Case RdCmdStr
          ...
          Case "ReadReserved"
                    ...
                    'frmGlinton.txt_Reserved_AccessPW.Text = ""
                    'frmGlinton.txt_Reserved_KillPW.Text = ""
                    
                    gTAG.ACC_RESULT = Mid(ByteValueOutput, 11, 2)
                    If (gTAG.ACC_RESULT = "DE") Then
                       
                        gTAG.RESERVED = Mid(ByteValueOutput, 17, 16)
                        'frmGlinton.txt_Reserved_KillPW.Text = Mid(ByteValueOutput, 17, 8)
                        'frmGlinton.txt_Reserved_AccessPW.Text = Mid(ByteValueOutput, 25, 8)
                        'frmGlinton.txt_Reserved_KillPW.Text = Mid(ByteValueOutput, 17, 8)
                        'frmGlinton.txt_Reserved_AccessPW.Text = Mid(ByteValueOutput, 25, 8)
          ...
          Case "ReadReservedAfterUpdateAccessPW"
                    ...
                    If (gTAG.ACC_RESULT = "00") Then
                        ...
                        gTAG.RESERVED = Mid(ByteValueOutput, 17, 16)
                        'frmGlinton.txt_Reserved_AccessPW.Text = frmGlinton.txt_Reserved_AccessPW_New
                        'frmGlinton.txt_Reserved_KillPW.Text = frmGlinton.txt_Reserved_KillPW_New.Text
                        Me.TagReadResult.FillColor = &HFF00&
          ...
          Case "ReadEPC"
                    ...
                    'frmGlinton.txt_EPC_Data = ""
                    gTAG.ACC_RESULT = Mid(ByteValueOutput, 11, 2)
                    If (gTAG.ACC_RESULT = "DE") Then
                       
                        gTAG.EPC = Mid(ByteValueOutput, 25, 24)
                        frmGlinton.txt_EPC_Data = gTAG.EPC
                        Me.TagReadResult.FillColor = &HFF00&
                    Else
          ...
          Case "ReadEPC_AfterWrote"
                    ...
                    If (gTAG.ACC_RESULT = "00") Then
                        ...
                        gTAG.EPC = Mid(ByteValueOutput, 39, 24)
                        frmGlinton.txt_EPC_Data = frmGlinton.txt_EPC_Data_New
                        Me.TagReadResult.FillColor = &HFF00&
          ...
          Case "ReadUser_AfterWrote64B"
                    ...
                    If (Mid(ByteValueOutput, 3, 8) = "07000700") Then
                        'frmGlinton.txt_User = 'frmGlinton.txt_User_New
                        Me.TagReadResult.FillColor = &HFF00&
          ...
          Case "ScanNewTag"
                    ...
                    If (Mid(ByteValueOutput, 7, 2) = "05") Then
                        If (CInt(Mid(ByteValueOutput, 21, 2)) > 0) Then
                             gTAG.EPC = Mid(ByteValueOutput, 39, 24)
                             frmGlinton.txt_EPC_Data.Text = gTAG.EPC
                             frmGlinton.txt_EPC_Data_New.Text = gTAG.EPC
...
If Cwritlong < Capabilities.OutputReportByteLength - 1 Then
    ...
    Next Wcont
End If
''frmGlinton.TextIR.Text = 'frmGlinton.TextIR.Text + "> " + temp + vbCrLf
